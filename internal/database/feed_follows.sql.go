...
SELECT get_feed_follows.id, get_feed_follows.created_at, get_feed_follows.updated_at, get_feed_follows.user_id, get_feed_follows.feed_id, feeds.name AS feed_name, users.name AS user_name
